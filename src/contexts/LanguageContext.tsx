...
const translations: Record<Language, Record<string, string>> = {
  ...
  ar: {
    ...
    'about.mission.text':
      'تتمثل رسالة SEUM في تمكين الشركات في المملكة العربية السعودية من خلال تقديم استشارات وحلول قانونية تجارية مصممة خصيصًا، نابعة من خبرة واسعة ورؤية عملية عميقة.',
    ...
    'strength1.text':
      'يجمع SEUM بين المعرفة القانونية المتعمقة وفهم الأعمال لتقديم حلول عملية للتحديات القانونية والتنظيمية اليومية.',
